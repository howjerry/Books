...
| 章節 | 標題 | 狀態 |
|------|------|------|
| Ch 4 | 狀態機思維——StateGraph 基礎 | ✅ 完成 |
| Ch 5 | 路由模式與人機協作 (HITL) | ✅ 完成 |
| Ch 6 | 多智能體協作——Supervisor 模式 | ✅ 完成 |
...
| 章節 | 標題 | 狀態 |
|------|------|------|
| Ch 10 | 可觀測性 (Observability) | ✅ 完成 |
| Ch 11 | 安全護欄 (Security & Guardrails) | ✅ 完成 |
| Ch 12 | 效能與成本優化 | ✅ 完成 |
| Ch 13 | 容器化與部署 | ✅ 完成 |
